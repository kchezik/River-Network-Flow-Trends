...
\begin{sidewaysfigure}[h]
	\centering
	\setfigurenum{S1}
	\noindent\includegraphics[width=55pc]{FigS1_SiteLogModels.pdf}
...
\begin{sidewaysfigure}[h]
	\centering
	\setfigurenum{S2}
	\noindent\includegraphics[width=55pc]{FigS2_SiteMonthLogModels.pdf}
...
\begin{figure}[h]
	\centering
	\setfigurenum{S3}
	\noindent\includegraphics[width=45pc]{FigS3_GlobalLogModel.pdf}
...
\begin{sidewaysfigure}[h]
	\centering
	\setfigurenum{S4}
	\noindent\includegraphics[width=52pc]{FigS4_SiteSim.pdf}
...
\begin{figure}[h]
	\centering
	\setfigurenum{S5}
	\noindent\includegraphics[width=45pc]{FigS5_BasinSim.pdf}
...
\begin{figure}[h]
	\centering
	\setfigurenum{S6}
	\noindent\includegraphics[width=40pc]{FigS6_MinMonth.pdf}
...
\begin{figure}[h]
	\centering
	\setfigurenum{S7}
	\noindent\includegraphics[width=40pc]{FigS7_MedMonth.pdf}
...
\begin{sidewaysfigure}[h]
	\centering
	\setfigurenum{S8}
	\noindent\includegraphics[width=55pc]{FigS8_HarvestYear.pdf}
...
\begin{sidewaysfigure}[h]
	\centering
	\setfigurenum{S9}
	\noindent\includegraphics[width=55pc]{FigS9_FlowCurvesRaw.pdf}
	\caption{Smoothed, five-day rolling average flow rates for each day in each year between 1970 and 2007 at 55 flow gauge stations in the Fraser River watershed. Years are colored oldest (red) to most recent (blue). The distributions demonstrate that flow in the Fraser River basin is defined by a spring melt and typically low summer flows. Flow timing, duration and magnitude vary between sites but are largely grouped by coastal and interior locations. For instance, sites 08MH006, 08MH029, 08MH076 and 08MH090 experience an earlier freshet and higher fall and winter flows due to their coastal proximity. }
	\label{fig:S9}
\end{sidewaysfigure}
